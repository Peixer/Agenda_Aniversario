...
public final class ConstantesSQL {
    ...
    public static String[] COLUMNS = new String[]{COLUMN_ID, COLUMN_NOME, COLUMN_DATE, COLUMN_EMAIL, COLUMN_URI};

    public static String DB_DROP = "DROP TABLE IF EXISTS " + DB_TABLE;
    public static String DB_CREATE = String.format("CREATE TABLE %s(%s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT NOT NULL, %s LONG, %s TEXT NOT NULL, %s TEXT NOT NULL);",
            DB_TABLE, COLUMN_ID, COLUMN_NOME, COLUMN_DATE, COLUMN_EMAIL, COLUMN_URI);
}
